...
export class PurchaseOrdersComponent implements OnInit {
  ...
  @ViewChild(PurchaseOrdersSearchComponent)
  private purchaseOrdersSearchComponent = {} as PurchaseOrdersSearchComponent;
  ...
  public getOrdersData(): void {
    this.spinner.show();
    this.api.order
      .getOrders(this.filter, '', '', 1, this.pageSize)
      .subscribe((response) => {
        this.grid = response;
  ...
  public openEditOrderModal(order: IOrder): void {
    const modalRef = this.modalService.open(PurchaseModalEditOrderComponent, {
      size: 'xl',
    });
    modalRef.componentInstance.order = order;
    modalRef.componentInstance.orderEdditedEvent.subscribe(() =>
      this.getOrdersData()
    );
