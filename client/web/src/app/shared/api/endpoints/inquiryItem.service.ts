...
export class InquiryItem {
  ...
  public editdInquiryItem(order: Partial<IInquiryItem[]>): Observable<IInquiryItem[]> {
    let params: any = {};
    ...
    return this.httpClient.put<IInquiryItem[]>(this.inquiriesItemsEndpointUrl, params);
  }
}
